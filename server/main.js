...
Meteor.startup(function() {
     ...
     var fileNameSmall = '/var/www/meteor/poolPicSmall.jpg'
     ...
     fs.watchFile(fileNameSmall, (curr, prev) => {
          curr.name = fileNameSmall;
          new Fiber(() => {
               ImageL.upsert({
                    name: fileNameSmall
               }, curr);
     ...
     Meteor.http.call("GET", url, function(error, result) {
          if (error) {
               ...
               RasPool.update({
                    ...
                    $set: {
                         currentTemp: Math.round(result.data.main.temp)
                    }
               });
          }
     });
